            ...
            <div class="col-12 mb-4">
                <div class="card h-100 shadow-sm border-0 p-2 ">
                    <div class="card-body d-flex flex-column ">
                        ...
                        <p class="card-text"><small class="text-muted"><strong>Type :</strong> ${c['job type']}</small></p>
                        
                        <p class="card-text"><small class="text-muted"><strong>Date :</strong> ${c['posted date']}</small></p>
                        ...
                        <p class="m-3 fst-italic">If you are interested in this role, please send your <strong>Cover Letter</strong> & <strong>Resume</strong> to <strong>${c['email'] }</strong> or give us a call at <strong>${c['phone']}</strong> and add below reference number in your subject line<br><div class='fst-normal'>Reference no : ${c['id']}</div></p>
                    </div>
